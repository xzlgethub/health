...
<link>
    ...
    <!--图片放大样式-->
    <link href="/project/Public/zoomify/zoomify.css" rel="stylesheet" type="text/css"/>
            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        ...
                        <small style="color:#888888">用户报告审核预览</small>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i><?php echo ($user); ?>报告审核预览
                            </div>
                        </div>
                        <div class="portlet-body">
                            <form role="form" class="form-horizontal form" enctype="multipart/form-data" action="/project/index.php/Manage/User/auditStatus" method="post">
                                <div class="form-body">
                                    <div class="form-group">
                                        <label class="control-label col-md-2">用户报告图片</label>
                                        <div class="col-md-7">
                                            <div class="example col-xs-3 col-md-3">
                                                <!--<img src="/project/Public/<?php echo ($information['thumbpic']); ?>" class="img-rounded">-->
                                                <img src="/project/Public/<?php echo ($information['pic']); ?>" class="img-rounded">
                                            </div>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-md-2">图片描述</label>
                                        <div class="col-md-10">
                                            <p class="form-control"><?php echo ($information['info']); ?></p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-2">报告类型</label>
                                        <div class="col-md-10">
                                            <p class="form-control"><?php echo ($information['reporttype']); ?></p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-2">审核状态</label>
                                        <div class="col-md-10">
                                            <p class="form-control"><?php echo ($information['audittype']); ?></p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-2">上传时间</label>
                                        <div class="col-md-10">
                                            <p class="form-control"><?php echo ($information['createtime']); ?></p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-2">更改审核状态</label>
                                        <div class="col-md-10">
                                            <select class="form-control" name="type" id="audittype">
...
<!--图片放大-->
<script src="/project/Public/zoomify/zoomify.js" type="text/javascript"></script>
<script>
