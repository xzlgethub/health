            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    <li>
                        ...
                        <a href="/health/index.php/Manage/Rule/RuleGroup">权限管理</a>
                    </li>
                    <li>
                        ...
                        <div class="portlet-body">
                            <div class="row">
                                <div class="col-md-3 col-md-push-0">
                                    <?php if(RuleCheck('Manage/Rule/addRuleGroup',$_SESSION['uid'])): ?><div class="btn-group">
                                            <a class="btn red-intense" href="/health/index.php/Manage/Rule/addRuleGroup"><i class="fa fa-plus"></i> 权限</a>
                                        </div><?php endif; ?>
                                </div>
                                <div class="col-md-5 col-md-push-4">
                                    <div class="row">
                                        <form action="/health/index.php/Manage/Rule/RuleGroup" method="get">
                            ...
                            <table class="table table-striped table-bordered table-hover" style="margin-top:10px">
                                ...
                                <?php if(is_array($res)): foreach($res as $key=>$res): ?><tr>
                                        ...
                                        <td>
                                            <?php if(RuleCheck('Manage/Rule/editAGaction',$_SESSION['uid'])): ?><a href="/health/index.php/Manage/Rule/editRuleGroup/id/<?php echo ($res["id"]); ?>/p/<?php echo ($page); ?>/sele/<?php echo ($sele); ?>">修改</a> |<?php endif; ?>
                                            <?php if(RuleCheck('Manage/Rule/delRuleGroup',$_SESSION['uid'])): ?><a href="javascript:delRuleGroup(<?php echo ($res["id"]); ?>,<?php echo ($page); ?>,<?php echo ($sele); ?>);">删除 </a><?php endif; ?>
                                        </td>
...
<script>
    function delRuleGroup(id,page,sele){
        ...
        if(confirm("确定要删除该条数据吗？")){
            //跳转网页,并携带参数
            window.location="/health/index.php/Manage/Rule/delRuleGroup/id/"+id+"/p/"+page+"/sele/"+sele;
        }
    }
    ...
    $(".lookup").click(function(){
        ...
        if(rules){
           // 发送ajax请求获取权限名称
            $.ajax({
                url: '/health/index.php/Manage/Rule/findRule',
                type: 'POST',
                dataType: 'json',
                data: {rules: rules},
