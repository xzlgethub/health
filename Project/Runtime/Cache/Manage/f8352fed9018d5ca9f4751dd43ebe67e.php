        ...
        <div class="page-content">
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    <li>
                        <i class="fa fa-shopping-cart"></i>
                        <a href="/health/index.php/Manage/Faq/index">常见问题管理</a>
                    </li>
                    <li>
                        ...
                        <div class="portlet-body">
                            <div class="row">
                                <div class="col-md-3 col-md-push-0">
                                    <?php if(RuleCheck('Manage/Management/add',$_SESSION['uid'])): ?><div class="btn-group">
                                            <a class="btn red-intense" href="/health/index.php/Manage/Faq/add"><i class="fa fa-plus"></i> 添加常见问题</a>
                                        </div><?php endif; ?>
                                </div>
                                <div class="col-md-8 col-md-push-2">
                                    <div class="row">
                                        <form action="/health/index.php/Manage/Faq/index" method="get">
                                            <div class="col-md-8 col-md-push-2" >
                            ...
                            <table class="table table-striped table-bordered table-hover" style="margin-top:10px">
                                ...
                                <?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td>
                                            <?php if(RuleCheck('Manage/Faq/edit',$_SESSION['uid'])): ?><a href="/health/index.php/Manage/Faq/edit/id/<?php echo ($vo["id"]); ?>/p/<?php echo ($page); ?>/sele/<?php echo ($sele); ?>" >修改</a> |<?php endif; ?>
                                            <?php if(RuleCheck('Manage/Faq/delAction',$_SESSION['uid'])): ?><a href="javascript:del(<?php echo ($vo["id"]); ?>,<?php echo ($page); ?>,'<?php echo ($sele); ?>');">删除 </a><?php endif; ?>
                                        </td>
...
<script>
    ...
    function del(id,p,sele){
        ...
        if(confirm("确定要删除该条数据吗？")){
            //跳转网页,并携带参数
            window.location="/health/index.php/Manage/Faq/delAction/id/"+id+"/p/"+p+"/sele/"+sele;
        }
    }
</script>
</body>
