                ...
                <div class="col-md-12">
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        ...
                        <div class="portlet-body">
                            <form role="form" class="form-horizontal form" enctype="multipart/form-data" action="/project/index.php/Manage/User/editAction" method="post">
                                <div class="form-body">
...
<script type="text/javascript">
    ...
    file.addEventListener('change',function(){
        ...
        if(size>1024){
            ...
            if(confirm("图片过大！！！")){
                //跳转网页,并携带参数
                //window.location="/project/index.php/Manage/User/delTypeAction/id/"+id;
            }
        }else{
            // 小于等于1024
    ...
    $(function () {
        $(".form-horizontal").validate({
            ...
            submitHandler:function(form){
                ...
                $.ajax({
                    type:"get",
                    url:"/project/index.php/Manage/User/vadataajax",
