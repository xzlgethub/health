                ...
                <div class="col-md-12">
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        ...
                        <div class="portlet-body">
                            <form role="form" class="form-horizontal form" enctype="multipart/form-data" action="/project/index.php/Manage/User/auditAction" method="post">
                                <div class="form-body">
                                    <div class="form-group">
                                        <label class="control-label col-md-2">用户报告图片</label>
                                        <div class="col-md-7">
                                            <img src="/project/Public/<?php echo ($information['thumbpic']); ?>">
                                        </div>
                                    </div>
