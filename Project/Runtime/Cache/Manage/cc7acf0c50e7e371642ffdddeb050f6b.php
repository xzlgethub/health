        ...
        <div class="page-content">
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    <li>
                        <i class="fa fa-shopping-cart"></i>
                        <a href="/health/index.php/Manage/Order/index">订单管理</a>
                    </li>
                    <li>
                        <i class="fa fa-angle-right"></i>
                        <small style="color:#888888">订单预览</small>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-shopping-cart"></i>订单预览
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="row">
                                <div class="col-md-3 col-md-push-0" style="display:inline;margin-left:10px;">
                                    <?php if(RuleCheck('Manage/Management/add',$_SESSION['uid'])): ?><div >
                                            <a class="btn red-intense" href="/health/index.php/Manage/Order/index"> 全部订单</a>
                                        </div><?php endif; ?>
                                </div>
                                <div class="col-md-3 col-md-push-0" style="display:inline;margin-left:-135px;">
                                    <?php if(RuleCheck('Manage/Management/add',$_SESSION['uid'])): ?><div >
                                            <a class="btn red-intense" href="/health/index.php/Manage/Order/index?type=2">未支付</a>
                                        </div><?php endif; ?>
                                </div>
                                <div class="col-md-3 col-md-push-0" style="display:inline;margin-left:-150px;">
                                    <?php if(RuleCheck('Manage/Management/add',$_SESSION['uid'])): ?><div >
                                            <a class="btn red-intense" href="/health/index.php/Manage/Order/index?type=3">待生效</a>
                                        </div><?php endif; ?>
                                </div>
                                <div class="col-md-3 col-md-push-0" style="display:inline;margin-left:-150px;">
                                    <?php if(RuleCheck('Manage/Management/add',$_SESSION['uid'])): ?><div >
                                            <a class="btn red-intense" href="/health/index.php/Manage/Order/index?type=4">已生效</a>
                                        </div><?php endif; ?>
                                </div>
                                <div class="col-md-3 col-md-push-0" style="display:inline;margin-left:-150px;">
                                    <?php if(RuleCheck('Manage/Management/add',$_SESSION['uid'])): ?><div >
                                            <a class="btn red-intense" href="/health/index.php/Manage/Order/index?type=5">发起服务</a>
                                        </div><?php endif; ?>
                                </div>
                                <div class="col-md-3 col-md-push-0">
                                    <div class="row">
                                        <form action="/health/index.php/Manage/Order/index" method="get">
                                            <div class="col-md-8 col-md-push-2" style="display:inline;padding-left:-25px;">
                                                <!--<input type="hidden" name="type" value="1">-->
                                                <input type="text" name="sele" placeholder="请输入服务名称搜索" class="form-control" value="<?php echo ($sele); ?>"  style="width:200px;">
                                            </div>
                                            <div class="col-md-1 col-md-push-1" style="margin-left:30px;">
                            ...
                            <table class="table table-striped table-bordered table-hover" style="margin-top:10px">
                                ...
                                <tr>
                                    ...
                                    <th>life</th>
                                    <th>订单状态</th>
                                    <?php if($serve_a == 1): ?><th>服务状态&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><?php endif; ?>
                                    <th>操作</th>
                                    <!--<th>操作&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>-->
                                </tr>
                                </thead>
                                ...
                                <?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><?php echo ($vo["insurance_name"]); ?></td>
                                        <td><?php echo ($vo["name"]); ?></td>
                                        <td><?php echo (date('Y-m-d H:i:s',$vo['create_time'])); ?></td>

                                        <td>
                                            <?php if($vo['pay_time'] != null): echo (date('Y-m-d H:i:s',$vo['pay_time'])); endif; ?>
                                        ...
                                        <td><?php echo ($vo["state"]); ?></td>
                                            ...
                                            <?php if($serve_a == 1): ?><td>
                                            <?php if($vo['serve_state'] == 1): ?><a href="" >已处理</a>
                                                <?php else: ?>
                                                <a href="javascript:upServe(<?php echo ($vo["id"]); ?>,<?php echo ($page); ?>,'<?php echo ($sele); ?>');">未处理 </a><?php endif; ?>
                                        </td><?php endif; ?>
                                        <td><a href="javascript:delOrder(<?php echo ($vo["id"]); ?>,<?php echo ($page); ?>,'<?php echo ($sele); ?>');"">删除</a></td>
                                   <!--     <td>
                                            <?php if(RuleCheck('Manage/Product/edit',$_SESSION['uid'])): ?><a href="/health/index.php/Manage/Order/edit/id/<?php echo ($vo["id"]); ?>/p/<?php echo ($page); ?>/sele/<?php echo ($sele); ?>" >修改</a> |<?php endif; ?>
...
&lt;!&ndash; IMPORTANT! Load jquery-ui.min.js before bootstrap.min.js to fix bootstrap tooltip conflict with jquery ui tooltip &ndash;&gt;
...
<script>
    ...
    function del(id,p,sele){
        ...
        if(confirm("确定要处理该服务请求吗？")){
            $.ajax({
                url:"<?php echo U('upServe');?>",
                type:'post',
                data:"id="+id,
                success:function(e){
                    if(e){
