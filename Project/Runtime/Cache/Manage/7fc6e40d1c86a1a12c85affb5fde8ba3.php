...
<head>
    ...
    <link href="/health/Public/assets/global/plugins/bootstrap-switch/css/bootstrap-switch.min.css" rel="stylesheet"
          type="text/css"/>
    ...
    <link id="style_color" href="/health/Public/assets/admin/layout/css/themes/darkblue.css" rel="stylesheet"
          type="text/css"/>
            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    <li>
                        ...
                        <a href="/health/index.php/Manage/Copyright/index">版权管理</a>
                    </li>
                    <li>
                        <i class="fa fa-angle-right"></i>
                        <small style="color:#888888">版权修改</small>
                    </li>
                </ul>
            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>版权修改
                            </div>
                        </div>
                        <div class="portlet-body">
                            <form role="form" id="commentForm" enctype="multipart/form-data" class="form-horizontal" action="/health/index.php/Manage/Copyright/editAction" method="post">
                                <div class="form-body">
                                    ...
                                    <!--<div class="form-group">
                                        <label class="control-label col-md-2">Logo类型</label>
                                        <div class="col-md-10">
                                            <select class="form-control" name="state">
                                                <option value="1">登录页Logo图</option>
                                                <option value="2">登录后Logo图</option>
                                            </select>
                                        </div>
                                    </div>-->
