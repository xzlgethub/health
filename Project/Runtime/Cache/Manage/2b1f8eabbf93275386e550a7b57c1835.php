            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    <li>
                        ...
                        <a href="/health/index.php/Manage/My/aboutus">关于我们管理</a>
                    </li>
                    <li>
                        ...
                        <div class="portlet-body">
                            <div class="row">
                                <div class="col-md-3 col-md-push-0">
                                    <?php if(RuleCheck('Manage/My/addabou',$_SESSION['uid'])): ?><div class="btn-group">
                                            <a class="btn red-intense" href="/health/index.php/Manage/My/addabou"><i class="fa fa-plus"></i>&nbsp;&nbsp;关于我们</a>
                                        </div><?php endif; ?>
                                </div>
                                <div class="col-md-8 col-md-push-2">
                                    <div class="row">
                                        <form action="/health/index.php/Manage/My/aboutus" method="get">
                                            <div class="col-md-8 col-md-push-2" >
                            ...
                            <table class="table table-striped table-bordered table-hover" style="margin-top:10px">
                                ...
                                <?php if(is_array($res)): foreach($res as $key=>$res): ?><tr>
                                        ...
                                        <td>
                                            <?php if(RuleCheck('Manage/My/edit',$_SESSION['uid'])): ?><a href="/health/index.php/Manage/My/edit/id/<?php echo ($res["id"]); ?>/p/<?php echo ($page); ?>/sele/<?php echo ($sele); ?>">修改</a> |<?php endif; ?>
                                            <?php if(RuleCheck('Manage/My/delaboutus',$_SESSION['uid'])): ?><a href="javascript:del(<?php echo ($res["id"]); ?>,<?php echo ($page); ?>,'<?php echo ($sele); ?>');">删除</a><?php endif; ?>
                                        </td>
...
<script>
    ...
    function del(id,page,sele){
        if(confirm("确定要删除该条数据吗？")){
            //跳转网页,并携带参数
            window.location="/health/index.php/Manage/My/delaboutus/id/"+id+"/p/"+page+"/sele/"+sele;
        }
    }
</script>
</body>
