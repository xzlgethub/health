            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    <li>
                        ...
                        <a href="/health/index.php/Manage/Feedback/index">意见反馈预览</a>
                    </li>
                    <li>
                            ...
                            <div class="row">
                                <div class="col-md-3 col-md-push-0">
                                    <!--<?php if(RuleCheck('Manage/Management/add',$_SESSION['uid'])): ?><div class="btn-group">
                                            <a class="btn red-intense" href="/health/index.php/Manage/Feedback/add"><i class="fa fa-plus"></i> 管理员</a>
                                        </div><?php endif; ?>-->
                                </div>
                                <div class="col-md-8 col-md-push-2">
                                    <div class="row">
                                        <form action="/health/index.php/Manage/Feedback/index" method="get">
...
<script>
    ...
    function del(id,page,sele){
        ...
        if(confirm("确定要删除该条数据吗？")){
            //跳转网页,并携带参数
            window.location="/health/index.php/Manage/Feedback/del/id/"+id+"/p/"+page+"/sele/"+sele;
        }
    }
</script>
</body>
