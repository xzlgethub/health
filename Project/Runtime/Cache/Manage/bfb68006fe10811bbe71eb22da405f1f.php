            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    <li>
                        ...
                        <a href="/health/index.php/Manage/Logo/index">Logo预览</a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        ...
                        <div class="portlet-body">
                            <div class="col-md-6" style="margin-bottom:10px;margin-left:-15px">
                                <?php if(RuleCheck('Manage/Logo/add',$_SESSION['uid'])): ?><div class="btn-group">
                                        <a class="btn red-intense" href="/health/index.php/Manage/Logo/add"><i class="fa fa-plus"></i> Logo</a>
                                    </div><?php endif; ?>
                            </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="">
                                ...
                                <?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        <td><img src="/health/Public/<?php echo ($vo["name"]); ?>" width="60"></td>
                                        <td style="vertical-align:middle"><?php echo ($res["time"]); ?></td>
                                        <td style="vertical-align:middle">
                                            <?php if($vo["state"] == '2'): ?><a href="/health/index.php/Manage/Logo/stateLogo/id/<?php echo ($vo["id"]); ?>/state/1" class="btn  btn-xs">【不展示】</a>
                                                <?php elseif($vo["state"] == '1'): ?>
                                                <a href="/health/index.php/Manage/Logo/stateLogo/id/<?php echo ($vo["id"]); ?>/state/2" class="btn btn-danger btn-xs">【展示】</a><?php endif; ?>
                                        </td>
                                        <td style="vertical-align:middle">
                                            <?php if($res != ''): if(RuleCheck('Manage/Logo/delAction',$_SESSION['uid'])): ?><a href="javascript:del(<?php echo ($vo["id"]); ?>);">删除 </a> |<?php endif; ?>
                                                <?php if(RuleCheck('Manage/Logo/edit',$_SESSION['uid'])): ?><a href="/health/index.php/Manage/Logo/edit/id/<?php echo ($vo["id"]); ?>">修改 </a><?php endif; endif; ?>
                                        </td>
...
<script>
    function del(id) {
        if (confirm("确定要删除这条消息吗？")) {
            //跳转网页,并携带参数
            window.location = "/health/index.php/Manage/Logo/delAction/id/" + id;
        }
    }
</script>
</body>
