            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        ...
                        <small style="color:#888888">权限修改</small>
                    </li>
                </ul>
            </div>
                ...
                <div class="col-md-12">
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>权限修改
                            </div>
                        </div>
                        <div class="portlet-body">
                            <form role="form" class="form-horizontal" action="/health/index.php/Manage/Rule/editAction" method="post">
                                <div class="form-body">
                                    ...
                                    <div class="form-group" style="margin-top:10px">
                                        <label class="control-label col-md-2">设置权限路径</label>
                                        <div class="col-md-10">
                                            <input type="text" value="<?php echo ($res['name']); ?>" class="form-control" name="name" placeholder="例如， Admin / 控制器名 / 方法名">
                                        </div>
                                    </div>
                                    <div class="form-group" style="margin-top:10px">
                                        ...
                                        <div class="col-md-10">
                                            <select name="classify" id="classify">
                                                ...
                                                <option value="1" <?php if($res['classify'] == 1): ?>selected<?php endif; ?> >首页</option>
                                                <option value="2" <?php if($res['classify'] == 2): ?>selected<?php endif; ?> >用户管理</option>
                                                <option value="3" <?php if($res['classify'] == 3): ?>selected<?php endif; ?> >管理员管理</option>
                                                <option value="4" <?php if($res['classify'] == 4): ?>selected<?php endif; ?> >权限管理</option>
                                                <option value="5" <?php if($res['classify'] == 5): ?>selected<?php endif; ?> >产品管理</option>
                                                <option value="6" <?php if($res['classify'] == 6): ?>selected<?php endif; ?> >Logo管理</option>
                                                <option value="7" <?php if($res['classify'] == 7): ?>selected<?php endif; ?> >版权管理</option>
                                                <option value="8" <?php if($res['classify'] == 8): ?>selected<?php endif; ?> >常见问题管理</option>
                                                <option value="9" <?php if($res['classify'] == 9): ?>selected<?php endif; ?> >关于我们</option>
                                                <option value="10" <?php if($res['classify'] == 10): ?>selected<?php endif; ?> >意见反馈</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group" style="margin-top:10px">
                                        ...
                                        <div class="col-md-10">
                                            <div class="btn-group">
                                                <button type="button" class="btn <?php if($res['status'] == 1 ): ?>btn-info<?php else: ?>btn-default<?php endif; ?>" name="putaway" status="1">开启</button>
                                                <button type="button" class="btn <?php if($res['status'] == 0 ): ?>btn-info<?php else: ?>btn-default<?php endif; ?>" name="putaway" status="0">关闭</button>
...
<script src="/health/Public/assets/admin/pages/scripts/components-editors.js"></script>
<script>
