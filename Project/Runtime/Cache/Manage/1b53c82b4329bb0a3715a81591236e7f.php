            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        ...
                        <small style="color:#888888">用户报告审核</small>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i><?php echo ($user["name"]); ?>报告审核预览
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-md-push-3">
                                    <div class="row">
                                        <form action="/project/index.php/Manage/User/audit" method="get">

                                            <div class="col-md-2 col-md-push-2">
                                                <select class="form-control" id="reporttype" name="reporttype">
                                                    <option value="">--请选择--</option>
                                                    <option value="1" <?php if($reporttype == 1): ?>selected<?php endif; ?> >体检报告</option>
                                                    <option value="2" <?php if($reporttype == 2): ?>selected<?php endif; ?> >病历报告</option>
                                                </select>
                                                <span class="tip"></span>
                                        ...
                                        <input type="text" name="sele" placeholder="请输入（用户昵称或手机号）内容进行搜索" class="form-control" value="<?php echo ($sele); ?>">
                                        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" style="margin-top:10px">
                                ...
                                <?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td>
                                            <img class="img" src="/project/Public/<?php echo ($vo["thumbpic"]); ?>">
                                        </td>
                                        ...
                                        <td>
                                            <?php if($vo["audittype"] == 0): ?><a href="/project/index.php/Manage/User/auditStatus/id/<?php echo ($vo["id"]); ?>/uid/<?php echo ($vo["uid"]); ?>/type/1/p/<?php echo ($p); ?>/reporttype/<?php echo ($reporttype); ?>/sele/<?php echo ($sele); ?>">通过</a>|
                                                <a href="/project/index.php/Manage/User/auditStatus/id/<?php echo ($vo["id"]); ?>/uid/<?php echo ($vo["uid"]); ?>/type/2/p/<?php echo ($p); ?>/reporttype/<?php echo ($reporttype); ?>/sele/<?php echo ($sele); ?>">未通过</a>
                                                <?php else: ?>
                                                    <?php if($vo["audittype"] == 1): ?>通过<?php else: ?>未通过<?php endif; endif; ?>
                                        </td>
                                        <td><?php echo ($vo["createtime"]); ?></td>
                                        <td>
                                            <?php if(RuleCheck('Manage/User/auditShow',$_SESSION['uid'])): ?><a href="/project/index.php/Manage/User/auditShow/id/<?php echo ($vo["id"]); ?>/uid/<?php echo ($vo["uid"]); ?>/p/<?php echo ($p); ?>/reporttype/<?php echo ($reporttype); ?>/sele/<?php echo ($sele); ?>">预览</a><?php endif; ?>
                                            <?php if(RuleCheck('Manage/User/auditDel',$_SESSION['uid'])): ?><a href="javascript:del(<?php echo ($vo["id"]); ?>,<?php echo ($p); ?>,'<?php echo ($sele); ?>');">删除 </a><?php endif; ?>
                                        </td>
...
<script>
    jQuery(document).ready(function() {
        ...
        TableAdvanced.init();
        Layout.setSidebarMenuActiveLink('set', $('#audit'));
    });
    function del(id,p,sele){
        ...
        if(confirm("确定要删除该条数据吗？")){
            //跳转网页,并携带参数
            window.location="/project/index.php/Manage/User/auditDel/id/"+id+"/p/"+p+"/sele/"+sele;
        }
    }
</script>
</body>
