            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    <li>
                        ...
                        <a href="/project/index.php/Manage/Logo/index">Logo管理</a>
                    </li>
                    <li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        ...
                        <div class="portlet-body">
                            <form role="form" id="commentForm" enctype="multipart/form-data" class="form-horizontal" action="/project/index.php/Manage/Logo/addAction" method="post">
                                <div class="form-body">
...
<script type="text/javascript">
    ...
    file.addEventListener('change',function(){
        ...
        if(size>1024){
            ...
            if(confirm("图片过大！！！")){
                //跳转网页,并携带参数
                //window.location="/project/index.php/Manage/Logo/delTypeAction/id/"+id;
            }
        }else{
