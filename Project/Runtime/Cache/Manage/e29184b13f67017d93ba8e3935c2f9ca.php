            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    <li>
                        ...
                        <a href="/health/index.php/Manage/Management/administrator">管理员管理</a>
                    </li>
                    <li>
                        ...
                        <div class="portlet-body">
                            <div class="row">
                                <div class="col-md-3 col-md-push-0">
                                    <?php if(RuleCheck('Manage/Management/add',$_SESSION['uid'])): ?><div class="btn-group">
                                            <a class="btn red-intense" href="/health/index.php/Manage/Management/add"><i class="fa fa-plus"></i> 管理员</a>
                                        </div><?php endif; ?>
                                </div>
                                <div class="col-md-5 col-md-push-4">
                                    <div class="row">
                                        <form action="/health/index.php/Manage/Management/administrator" method="get">
                            ...
                            <table class="table table-striped table-bordered table-hover" style="margin-top:10px">
                                ...
                                <?php if(is_array($res)): foreach($res as $key=>$res): ?><tr>
                                        ...
                                        <td>
                                            <?php if(RuleCheck('Manage/Management/edit',$_SESSION['uid'])): ?><a href="/health/index.php/Manage/Management/edit/id/<?php echo ($res["id"]); ?>/p/<?php echo ($page); ?>/sele/<?php echo ($sele); ?>">修改</a> |<?php endif; ?>
                                            <!--<?php if(RuleCheck('Manage/Management/repassword',$_SESSION['uid'])): ?><a href="javascript:repassword(<<?php echo ($res["id"]); ?>>);">重置密码</a> |<?php endif; ?>-->
                                            <?php if(RuleCheck('Manage/Management/del',$_SESSION['uid'])): ?><a href="javascript:del(<?php echo ($res["id"]); ?>,<?php echo ($page); ?>,<?php echo ($sele); ?>);">删除 </a><?php endif; ?>
                                        </td>
...
<script>
    function del(id,p,sele){
        ...
        if(confirm("确定要删除该条数据吗？")){
            //跳转网页,并携带参数
            window.location="/health/index.php/Manage/Management/del/id/"+id+"/p/"+p+"/sele/"+sele;
        }
    }
