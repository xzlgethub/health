            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    <li>
                        ...
                        <a href="/project/index.php/Manage/My/aboutus">关于我们管理</a>
                    </li>
                    <li>
                        <i class="fa fa-angle-right"></i>
                        <small style="color:#888888">关于我们添加</small>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>关于我们添加
                            </div>
                        </div>
                        <div class="portlet-body">
                            <form role="form" class="form-horizontal form" enctype="multipart/form-data" action="/project/index.php/Manage/My/addAction" method="post">
                                <div class="form-group">
                                    <label class="control-label col-md-2">内容</label>
                                    <div class="col-md-10">
                                        <textarea name="content" class="form-control font-color" cols="50" rows="6" required></textarea>
                                        <span class="tip"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <textarea name="copyright" class="form-control font-color" cols="50" rows="6" required></textarea>
                                        <span class="tip"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control font-color" name="versions" id="versions" value="">
                                        <span class="tip"></span>
                                    </div>
                                </div>
