                ...
                <div class="col-md-12">
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        ...
                        <div class="portlet-body">
                            <form role="form" class="form-horizontal form" action="/project/index.php/Manage/Management/editAction" method="post">
                                <div class="form-body">
                                    ...
                                    <div class="form-group" style="margin-top:10px">
                                        <label class="control-label col-md-2">角色组</label>
                                        <div class="col-md-10">
                                            <select class="form-control" id="type" name="type">
                                                <option value="0">请选择</option>
                                                <?php if(is_array($re)): foreach($re as $key=>$re): ?><option value="<?php echo ($re['id']); ?>" <?php if($res['type'] == $re['id']): ?>selected<?php endif; ?> ><?php echo ($re['title']); ?></option><?php endforeach; endif; ?>
                                            </select>
                                            <span class="tip"></span>
