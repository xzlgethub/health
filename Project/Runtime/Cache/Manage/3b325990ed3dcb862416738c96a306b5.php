            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    <li>
                        ...
                        <a href="/health/index.php/Manage/User/index">用户管理</a>
                    </li>
                    <li>
                        ...
                        <div class="portlet-body">
                            <div class="row">
                                <div class="col-md-3 col-md-push-0">
                                    <!--<?php if(RuleCheck('Manage/Management/add',$_SESSION['uid'])): ?><div class="btn-group">
                                            <a class="btn red-intense" href="/health/index.php/Manage/User/add"><i class="fa fa-plus"></i> 管理员</a>
                                        </div><?php endif; ?>-->
                                </div>
                                <div class="col-md-8 col-md-push-2">
                                    <div class="row">
                                        <form action="/health/index.php/Manage/User/index" method="get">
                            ...
                            <table class="table table-striped table-bordered table-hover" style="margin-top:10px">
                                ...
                                <?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        <td><img src="/health/Public/<?php echo ($vo["thumbpic"]); ?>" width="25" height="25"></td>
                                        ...
                                        <td>
                                            <?php if(RuleCheck('Manage/User/stateUser',$_SESSION['uid'])): if($vo["status"] == 0): ?><a href="/health/index.php/Manage/User/statusUser/id/<?php echo ($vo["id"]); ?>/type/1/page/<?php echo ($page); ?>/sele/<?php echo ($sele); ?>" class="btn  btn-xs">【取消限制】</a>
                                                <?php elseif($vo["status"] == 1): ?>
                                                    <a href="/health/index.php/Manage/User/statusUser/id/<?php echo ($vo["id"]); ?>/type/0/page/<?php echo ($page); ?>/sele/<?php echo ($sele); ?>" class="btn btn-danger btn-xs">【限制登录】</a><?php endif; endif; ?>
                                        </td>
                                        <td><a href="/health/index.php/Manage/User/userStep/id/<?php echo ($vo["id"]); ?>">查询该用户步数</a></td>
                                        <td><a href="/health/index.php/Manage/User/userReport/id/<?php echo ($vo["id"]); ?>">查看资料</a></td>
                                        <td><?php echo ($vo["createtime"]); ?></td>
                                        <td>
                                            <?php if(RuleCheck('Manage/User/edit',$_SESSION['uid'])): ?><a href="/health/index.php/Manage/User/edit/id/<?php echo ($vo["id"]); ?>/p/<?php echo ($page); ?>/sele/<?php echo ($sele); ?>" >修改</a> |<?php endif; ?>
                                            <?php if(RuleCheck('Manage/User/del',$_SESSION['uid'])): ?><a href="javascript:del(<?php echo ($vo["id"]); ?>,<?php echo ($page); ?>,<?php echo ($sele); ?>);">删除 </a><?php endif; ?>
                                        </td>
...
<script>
    ...
    function del(id,p,sele){
        ...
        if(confirm("确定要删除该条数据吗？")){
            //跳转网页,并携带参数
            window.location="/health/index.php/Manage/User/del/id/"+id+"/p/"+p+"/sele/"+sele;
        }
    }
   ...
   function li(id,type,ty){
        if(confirm("确定限制登陆吗？")){
            //跳转网页,并携带参数
            window.location="/health/index.php/Manage/User/stateUser/id/"+id+"/type/"+type+"/ty/"+ty;
        }
    }
