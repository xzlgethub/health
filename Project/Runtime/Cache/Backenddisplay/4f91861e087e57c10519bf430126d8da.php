            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        ...
                        <small style="color:#888888">用户预览</small>
                    </li>
                </ul>
            </div>
            <div class="row">
                        ...
                        <div class="portlet-body">
                            <div class="row">
                                <div class="col-md-3 col-md-push-0">
                                    <!--<?php if(RuleCheck('Backenddisplay/Management/add',$_SESSION['uid'])): ?><div class="btn-group">
                                            <a class="btn red-intense" href="/project/index.php/Backenddisplay/User/add"><i class="fa fa-plus"></i> 管理员</a>
                                        </div><?php endif; ?>-->
                                </div>
                                <div class="col-md-8 col-md-push-2">
                                    <div class="row">
                                        <form action="/project/index.php/Backenddisplay/User/index" method="get">
                                            ...
                                            <div class="col-md-8 col-md-push-2" >
                                                ...
                                                <input type="text" name="sele" placeholder="请输入（姓名/手机号）内容进行搜索" class="form-control" value="<?php echo ($sele); ?>">
                                            </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" style="margin-top:10px">
                                ...
                                <?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        <td><img src="/project/Public/<?php echo ($vo["thumbpic"]); ?>" width="25" height="25"></td>
                                        <td><?php echo ($vo["name"]); ?></td>
                                        <td><?php echo ($vo["sex"]); ?></td>
                                        <td><?php echo ($vo["phone"]); ?></td>
                                        <td><?php echo ($vo["life"]); ?></td>
                                        <td><?php echo ($vo["lis"]); ?></td>
                                        <td>
                                            <?php if(RuleCheck('Backenddisplay/User/stateUser',$_SESSION['uid'])): if($vo["status"] == 0): ?><a href="/project/index.php/Backenddisplay/User/statusUser/id/<?php echo ($vo["id"]); ?>/type/1/page/<?php echo ($page); ?>/sele/<?php echo ($sele); ?>" class="btn  btn-xs">【取消限制】</a>
                                                <?php elseif($vo["status"] == 1): ?>
                                                    <a href="/project/index.php/Backenddisplay/User/statusUser/id/<?php echo ($vo["id"]); ?>/type/0/page/<?php echo ($page); ?>/sele/<?php echo ($sele); ?>" class="btn btn-danger btn-xs">【限制登录】</a><?php endif; endif; ?>
                                        </td>
                                        <td><a href="/project/index.php/Backenddisplay/User/userStep/id/<?php echo ($vo["id"]); ?>">查询该用户步数</a></td>
                                        <td><a href="/project/index.php/Backenddisplay/User/userReport/id/<?php echo ($vo["id"]); ?>">查看资料</a></td>
                                        <td><?php echo ($vo["createtime"]); ?></td>
                                        <td>
                                            <?php if(RuleCheck('Backenddisplay/User/edit',$_SESSION['uid'])): ?><a href="/project/index.php/Backenddisplay/User/edit/id/<?php echo ($vo["id"]); ?>/p/<?php echo ($page); ?>/sele/<?php echo ($sele); ?>" >修改</a> |<?php endif; ?>
                                            <?php if(RuleCheck('Backenddisplay/User/del',$_SESSION['uid'])): ?><a href="javascript:del(<?php echo ($vo["id"]); ?>,<?php echo ($page); ?>,<?php echo ($sele); ?>);">删除 </a><?php endif; ?>
                                        </td>
...
<script>
    ...
    function del(id,p,sele){
        ...
        if(confirm("确定要删除该条数据吗？")){
            //跳转网页,并携带参数
            window.location="/project/index.php/Backenddisplay/User/del/id/"+id+"/p/"+p+"/sele/"+sele;
        }
    }

   function li(id,type,ty){
        if(confirm("确定限制登陆吗？")){
            //跳转网页,并携带参数
            window.location="/project/index.php/Backenddisplay/User/stateUser/id/"+id+"/type/"+type+"/ty/"+ty;
        }
    }

    function lim(id,type,ty){
        if(confirm("确定取消限制吗？")){
            //跳转网页,并携带参数
            window.location="/project/index.php/Backenddisplay/User/stateUser/id/"+id+"/type/"+type+"/ty/"+ty;
        }
