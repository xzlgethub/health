            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    <li>
                        ...
                        <a href="/project/index.php/Backenddisplay/Software/index">APP软件预览</a>
                    </li>
                    <li>
                        <i class="fa fa-angle-right"></i>
                        <small style="color:#888888">APP软件预览</small>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>APP软件预览
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="row">
                                <div class="col-md-3 col-md-push-0">
                                    <?php if(RuleCheck('Backenddisplay/Software/add',$_SESSION['uid'])): ?><div class="btn-group">
                                            <a class="btn red-intense" href="/project/index.php/Backenddisplay/Software/add"><i class="fa fa-plus"></i> 管理员</a>
                                        </div><?php endif; ?>
                                </div>
                            </div>
                            <table class="table table-striped table-bordered table-hover" style="margin-top:10px">
                                ...
                                <?php if(is_array($res)): foreach($res as $key=>$res): ?><tr>
                                        <td><<?php echo ($res["version_code"]); ?>></td>
                                        <td><<?php echo ($res["version_des"]); ?>></td>
                                        <td><<?php echo ($res["time"]); ?>></td>
                                        <td><a href="javascript:del(<<?php echo ($res["id"]); ?>>);">删除</a></td>
                                        <!-- <td>
                                             <?php if($res["state"] == 0): ?><a href="/project/index.php/Backenddisplay/Software/state/id/<<?php echo ($res["id"]); ?>>">禁用</a> |
                                         <?php else: endif; ?>
                                             <a href="/project/index.php/Backenddisplay/Software/edit/id/<<?php echo ($res["id"]); ?>>">修改</a> |
                                             <a href="javascript:del(<<?php echo ($res["id"]); ?>>);">删除</a>
                                         </td>-->
...
<script>
    jQuery(document).ready(function() {
        ...
        TableAdvanced.init();
        Layout.setSidebarMenuActiveLink('set', $('#Software'));
    });

    function del(id){
        if(confirm("确定要删除该条数据吗？")){
            //跳转网页,并携带参数
            window.location="/project/index.php/Backenddisplay/Software/del/id/"+id;
        }
    }
</script>
</body>
