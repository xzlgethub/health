...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="/project/Public/assets/global/plugins/datatables/extensions/Scroller/css/dataTables.scroller.min.css"/>
    <link rel="stylesheet" type="text/css"
          href="/project/Public/assets/global/plugins/datatables/extensions/ColReorder/css/dataTables.colReorder.min.css"/>
    <link rel="stylesheet" type="text/css"
          href="/project/Public/assets/global/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.css"/>
            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    <li>
                        ...
                        <a href="/project/index.php/Backenddisplay/Slide/index">轮播图管理</a>
                    </li>
                    <li>
                        <i class="fa fa-angle-right"></i>
                        <small style="color:#888888">轮播图预览</small>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>轮播图预览
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="row">
                                <div class="col-md-3 col-md-push-0">
                                    <?php if(RuleCheck('Backenddisplay/Slide/add',$_SESSION['uid'])): ?><div class="btn-group">
                                            <a class="btn red-intense" href="/project/index.php/Backenddisplay/Slide/add"><i class="fa fa-plus"></i>&nbsp;&nbsp;轮播图</a>
                                        </div><?php endif; ?>
                                </div>
                                <!--<div class="col-md-6 col-md-push-2">
                                    <div class="row">
                                        <form action="/project/index.php/Backenddisplay/Slide/seeAdv" method="post">
                                            <div class="col-md-8 col-md-push-5" >
                                                <input type="hidden" name="type" value="1">
                                                <input type="text" name="sele" placeholder="请输入关键字进行搜索" class="form-control" >
                                            </div>
                                            <div class="col-md-1 col-md-push-4" style="margin-left:0px;">
                            ...
                            <table class="table table-striped table-bordered table-hover" style="margin-top:10px">
                                ...
                                <?php if(is_array($res)): foreach($res as $key=>$res): ?><tr>
                                        <td >
                                            <img src="/project/Public/slide/<<?php echo ($res["pic"]); ?>>" style="width:40px"/>
                                        </td>
                                        <td><<?php echo ($res["name"]); ?>></td>
                                        <td><<?php echo ($res["link"]); ?>></td>
                                        <td><<?php echo ($res["starttime"]); ?>></td>
                                        <td><<?php echo ($res["endtime"]); ?>></td>
                                        <td><?php if($res['status'] != '1'): ?>启用<?php else: ?>禁用<?php endif; ?></td>
                                        <td>
                                            <?php if(RuleCheck('Backenddisplay/Slide/status',$_SESSION['uid'])): if($res['status'] != '1'): ?><a href="/project/index.php/Backenddisplay/Slide/status/id/<<?php echo ($res["id"]); ?>>/type/1">禁用 </a> |
                                                    <?php else: ?>
                                                    <a href="/project/index.php/Backenddisplay/Slide/status/id/<<?php echo ($res["id"]); ?>>/type/0">启用 </a> |<?php endif; endif; ?>
                                            <?php if(RuleCheck('Backenddisplay/Slide/delAction',$_SESSION['uid'])): ?><a href="javascript:del(<<?php echo ($res["id"]); ?>>);">删除 </a> |<?php endif; ?>
                                            <?php if(RuleCheck('Backenddisplay/Slide/edit',$_SESSION['uid'])): ?><a href="/project/index.php/Backenddisplay/Slide/edit/id/<<?php echo ($res["id"]); ?>>">修改 </a><?php endif; ?>
                                        </td>
                                        <input class="data-id" type="hidden" value="<<?php echo ($res["id"]); ?>>" />
...
<script src="/project/Public/assets/global/plugins/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js"
        type="text/javascript"></script>
<script src="/project/Public/assets/global/plugins/jquery-slimscroll/jquery.slimscroll.min.js"
        type="text/javascript"></script>
...
<script src="/project/Public/assets/global/plugins/bootstrap-switch/js/bootstrap-switch.min.js"
        type="text/javascript"></script>

<script type="text/javascript" src="/project/Public/assets/global/plugins/select2/select2.min.js"></script>
<script type="text/javascript"
        src="/project/Public/assets/global/plugins/datatables/media/js/jquery.dataTables.min.js"></script>
<script type="text/javascript"
        src="/project/Public/assets/global/plugins/datatables/extensions/TableTools/js/dataTables.tableTools.min.js"></script>
<script type="text/javascript"
        src="/project/Public/assets/global/plugins/datatables/extensions/ColReorder/js/dataTables.colReorder.min.js"></script>
<script type="text/javascript"
        src="/project/Public/assets/global/plugins/datatables/extensions/Scroller/js/dataTables.scroller.min.js"></script>
<script type="text/javascript"
        src="/project/Public/assets/global/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.js"></script>
...
<script>
    jQuery(document).ready(function () {
        ...
        TableEditable.init();
        Layout.setSidebarMenuActiveLink('set', $('#page222'));
    });
</script>
<script>
    function del(id) {
        if (confirm("确定要删除这条消息吗？")) {
            //跳转网页,并携带参数
            window.location = "/project/index.php/Backenddisplay/Slide/delAction/id/" + id;
        }
    }
    ...
    var time = new Date(Date.parse(times.replace(/-/g, "/")));
    time = time.getTime();
    ...
    $(document).ready(function () {
        $('#test tr').each(function () {
            var endtime =$(this).children('td').eq(4).html();
            //console.log(endtime);
            var date = new Date(Date.parse(endtime.replace(/-/g, "/")));
            date = date.getTime();
            var uid = $(this).find('.data-id').val();
            if(date<=time){
                arr.push(uid);
            }
        });
        ...
        $.ajax({
            type:"get",
            url:"/project/index.php/Backenddisplay/Slide/slideajax",
            data:{uid:arr},
