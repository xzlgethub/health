...
<head>
    ...
    <link href="/project/Public/assets/admin/pages/css/login.css" rel="stylesheet" type="text/css"/>
    <!-- END PAGE LEVEL SCRIPTS -->
    <!-- BEGIN THEME STYLES -->
    <link href="/project/Public/assets/global/css/components-rounded.css" id="style_components" rel="stylesheet"
          type="text/css"/>
    ...
    <link href="/project/Public/assets/admin/layout/css/themes/default.css" rel="stylesheet" type="text/css"
          id="style_color"/>
    <link href="/project/Public/assets/admin/layout/css/custom.css" rel="stylesheet" type="text/css"/>
    <!-- END THEME STYLES -->
    <link rel="shortcut icon" type="image/ico" href="/project/favicon.ico">
...
<div class="logo">
    <a href="index.html">
        <img src="/project/Public/<?php echo ($logo['name']); ?>" width="200" />
    </a>
</div>
<div class="content" style="margin-top:10px;">
    <form class="login-form" id="registerForm frm1" action="/project/index.php/Backenddisplay/Login/login" method="post">
...
<script src="/project/Public/assets/global/plugins/jquery-validation/js/jquery.validate.min.js"
        type="text/javascript"></script>
<script src="/project/Public/assets/global/plugins/jquery-migrate.min.js" type="text/javascript"></script>
<script src="/project/Public/assets/admin/layout/scripts/jquery.validate.min.js" type="text/javascript"></script>
        ...
        $(".login-form").validate({
            ...
            submitHandler: function (form) {
                ...
                if (name == '' && pass == '') {
                    ...
                    $.ajax({
                        type: "get",
                        url: "/project/index.php/Backenddisplay/Login/vadataajax",
