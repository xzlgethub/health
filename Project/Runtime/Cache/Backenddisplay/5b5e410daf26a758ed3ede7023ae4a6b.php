            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        ...
                        <small style="color:#888888">关于我们预览</small>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>关于我们预览
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="row">
                                <div class="col-md-3 col-md-push-0">
                                    <?php if(RuleCheck('Backenddisplay/My/addabou',$_SESSION['uid'])): ?><div class="btn-group">
                                            <a class="btn red-intense" href="/project/index.php/Backenddisplay/My/addabou"><i class="fa fa-plus"></i>&nbsp;&nbsp;关于我们</a>
                                        </div><?php endif; ?>
                                </div>
                                <div class="col-md-8 col-md-push-2">
                                    <div class="row">
                                        <form action="/project/index.php/Backenddisplay/My/aboutus" method="get">
                                            <div class="col-md-8 col-md-push-2" >
                                                <input type="hidden" name="type" value="1">
                                                <input type="text" name="sele" placeholder="请输入（版本号）内容进行搜索" class="form-control" value="<?php echo ($sele); ?>">
                                            </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" style="margin-top:10px">
                                ...
                                <?php if(is_array($res)): foreach($res as $key=>$res): ?><tr>
                                        <td><textarea class="form-control font-color" cols="60" rows="3"><?php echo ($res["content"]); ?></textarea></td>
                                        <td><?php echo ($res["copyright"]); ?></td>
                                        <td><?php echo ($res["versions"]); ?></td>
                                        <td><?php echo ($res["save_time"]); ?></td>
                                        <td>
                                            <?php if(RuleCheck('Backenddisplay/My/edit',$_SESSION['uid'])): ?><a href="/project/index.php/Backenddisplay/My/edit/id/<?php echo ($res["id"]); ?>/p/<?php echo ($page); ?>/sele/<?php echo ($sele); ?>">修改</a> |<?php endif; ?>
                                            <?php if(RuleCheck('Backenddisplay/My/delaboutus',$_SESSION['uid'])): ?><a href="javascript:del(<?php echo ($res["id"]); ?>,<?php echo ($page); ?>,'<?php echo ($sele); ?>');">删除</a><?php endif; ?>
                                        </td>
...
<script>
    ...
    function del(id,page,sele){
        if(confirm("确定要删除该条数据吗？")){
            //跳转网页,并携带参数
            window.location="/project/index.php/Backenddisplay/My/delaboutus/id/"+id+"/p/"+page+"/sele/"+sele;
        }
    }
</script>
</body>
