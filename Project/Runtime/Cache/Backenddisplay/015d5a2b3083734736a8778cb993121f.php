            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    <li>
                        ...
                        <a href="/project/index.php/Backenddisplay/Rule/index">权限管理</a>
                    </li>
                    <li>
                        ...
                        <div class="portlet-body">
                            <div class="row">
                                <div class="col-md-3 col-md-push-0">
                                    <?php if(RuleCheck('Backenddisplay/Rule/editAction',$_SESSION['uid'])): ?><div class="btn-group">
                                            <a class="btn red-intense" href="/project/index.php/Backenddisplay/Rule/add"><i class="fa fa-plus"></i> 权限</a>
                                        </div><?php endif; ?>
                                </div>
                                <div class="col-md-5 col-md-push-4">
                                    <div class="row">
                                        <form action="/project/index.php/Backenddisplay/Rule/seepeople" method="post">
                            ...
                            <table class="table table-striped table-bordered table-hover" style="margin-top:10px">
                                ...
                                <tbody>
                                    <?php if(is_array($res)): foreach($res as $key=>$res): ?><tr>
                                            ...
                                            <td>
                                                <?php if(RuleCheck('Backenddisplay/Rule/editAction',$_SESSION['uid'])): ?><a href="/project/index.php/Backenddisplay/Rule/edit/id/<?php echo ($res["id"]); ?>/p/<?php echo ($page); ?>/sele/<?php echo ($sele); ?>">修改</a> |<?php endif; ?>
                                                <?php if(RuleCheck('Backenddisplay/Rule/delRule',$_SESSION['uid'])): ?><a href="javascript:delRule(<?php echo ($res["id"]); ?>,<?php echo ($page); ?>,<?php echo ($sele); ?>);">删除 </a><?php endif; ?>
                                            </td>
...
<script>
    function delRule(id,page,sele){
        ...
        if(confirm("确定要删除该条数据吗？")){
            //跳转网页,并携带参数
            window.location="/project/index.php/Backenddisplay/Rule/delRule/id/"+id+"/p/"+page+"/sele/"+sele;
        }
    }
</script>
</body>
