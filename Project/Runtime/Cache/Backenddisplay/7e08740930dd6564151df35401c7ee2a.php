            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    <li>
                        ...
                        <a href="/project/index.php/Backenddisplay/Index/index">首页</a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="row" >
                            <div class="htmleaf-content">
                                <div style="width:97%;margin:0 auto;"><!--background-color: #Ffffff;-->
...
<script src="/project/Public/assets/global/plugins/morris/morris.min.js" type="text/javascript"></script>
<script src="/project/Public/assets/global/plugins/counterup/jquery.waypoints.min.js" type="text/javascript"></script>
<script src="/project/Public/assets/global/plugins/counterup/jquery.counterup.min.js" type="text/javascript"></script>
<script src="/project/Public/assets/global/scripts/app.min.js" type="text/javascript"></script>
<script src="/project/Public/assets/global/scripts/Chart.js" type="text/javascript"></script>
