        ...
        <div class="page-content">
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    <li>
                        <i class="fa fa-shopping-cart"></i>
                        <a href="/project/index.php/Backenddisplay/Faq/index">常见问题管理</a>
                    </li>
                    <li>
                        <i class="fa fa-angle-right"></i>
                        <small style="color:#888888">常见问题预览</small>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-shopping-cart"></i>常见问题预览
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="row">
                                <div class="col-md-3 col-md-push-0">
                                    <?php if(RuleCheck('Backenddisplay/Management/add',$_SESSION['uid'])): ?><div class="btn-group">
                                            <a class="btn red-intense" href="/project/index.php/Backenddisplay/Faq/add"><i class="fa fa-plus"></i> 添加常见问题</a>
                                        </div><?php endif; ?>
                                </div>
                                <div class="col-md-8 col-md-push-2">
                                    <div class="row">
                                        <form action="/project/index.php/Backenddisplay/Faq/index" method="get">
                                            <div class="col-md-8 col-md-push-2" >
                                                <!--<input type="hidden" name="type" value="1">-->
                                                <input type="text" name="sele" placeholder="请输入（标题）内容进行搜索" class="form-control" value="<?php echo ($sele); ?>">
                                            </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" style="margin-top:10px">
                                ...
                                <?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td>
                                            <?php if(RuleCheck('Backenddisplay/Faq/edit',$_SESSION['uid'])): ?><a href="/project/index.php/Backenddisplay/Faq/edit/id/<?php echo ($vo["id"]); ?>/p/<?php echo ($page); ?>/sele/<?php echo ($sele); ?>" >修改</a> |<?php endif; ?>
                                            <?php if(RuleCheck('Backenddisplay/Faq/delAction',$_SESSION['uid'])): ?><a href="javascript:del(<?php echo ($vo["id"]); ?>,<?php echo ($page); ?>,'<?php echo ($sele); ?>');">删除 </a><?php endif; ?>
                                        </td>
...
<script>
    ...
    function del(id,p,sele){
        ...
        if(confirm("确定要删除该条数据吗？")){
            //跳转网页,并携带参数
            window.location="/project/index.php/Backenddisplay/Faq/delAction/id/"+id+"/p/"+p+"/sele/"+sele;
        }
    }
</script>
</body>
