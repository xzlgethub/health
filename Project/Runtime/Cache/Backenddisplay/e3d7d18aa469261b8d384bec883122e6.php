                ...
                <div class="col-md-12">
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        ...
                        <div class="portlet-body">
                            <form role="form" class="form-horizontal form" action="/project/index.php/Backenddisplay/Product/editAction" method="post" enctype="multipart/form-data">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <img src="/project/Public/<?php echo ($res["thumb_img"]); ?>">
                                        </div>
