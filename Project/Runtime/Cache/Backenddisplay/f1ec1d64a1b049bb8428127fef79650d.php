            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        ...
                        <small style="color:#888888">版权添加</small>
                    </li>
                </ul>
            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>版权添加
                            </div>
                        </div>
                        <div class="portlet-body">
                            <form role="form" class="form-horizontal" action="/project/index.php/Backenddisplay/Copyright/addAction" method="post">
                                <div class="form-body">
