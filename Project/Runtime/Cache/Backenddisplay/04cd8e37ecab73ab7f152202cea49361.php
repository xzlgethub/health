                ...
                <div class="col-md-12">
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        ...
                        <div class="portlet-body">
                            <form role="form" class="form-horizontal form" action="/project/index.php/Backenddisplay/Product/addAction" method="post" enctype="multipart/form-data">
                                <div class="form-body">
...
<script type="text/javascript">
    ...
    file.addEventListener('change',function(){
        ...
        if(size>2048){
            ...
            if(confirm("图片过大！！！")){
                //跳转网页,并携带参数
                //window.location="/project/index.php/Backenddisplay/Product/delTypeAction/id/"+id;
            }
        }else{
            // 小于等于2048
