            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        ...
                        <small style="color:#888888">Logo修改</small>
                    </li>
                </ul>
            </div>
                ...
                <div class="col-md-12">
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>Logo修改
                            </div>
                        </div>
                        <div class="portlet-body">
                            <form role="form" id="commentForm" enctype="multipart/form-data" class="form-horizontal" action="/project/index.php/Backenddisplay/Logo/editAction" method="post">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <select class="form-control" name="state">
                                                ...
                                                <?php if($res["state"] == '1'): ?><option value="1" selected="selected">展示</option>
                                                    <option value="2" >不展示</option>
                                                    <?php else: ?>
                                                    <option value="1" >展示</option>
                                                    <option value="2" selected="selected">不展示</option><?php endif; ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group" style="margin-top:10px;">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="hidden" name="yname" value="<?php echo ($res["name"]); ?>" />
