            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        ...
                        <small style="color:#888888">权限添加</small>
                    </li>
                </ul>
            </div>
                ...
                <div class="col-md-12">
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>权限添加
                            </div>
                        </div>
                        <div class="portlet-body">
                            <form role="form" class="form-horizontal" action="/project/index.php/Backenddisplay/Rule/addAction" method="post">
                                <div class="form-body">
                                    ...
                                    <div class="form-group" style="margin-top:10px">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="name" placeholder="格式，Amin / 控制器 / 方法">
                                        </div>
                                    </div>
                                    <div class="form-group" style="margin-top:10px">
                                        ...
                                        <div class="col-md-10">
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-info" name="putaway" status="1">开启</button>
                                                <button type="button" class="btn btn-default" name="putaway" status="0">关闭</button>
