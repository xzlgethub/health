            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        ...
                        <small style="color:#888888">常见问题修改</small>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>常见问题修改
                            </div>
                        </div>
                        <div class="portlet-body">
                            <form role="form" class="form-horizontal form" action="/project/index.php/Backenddisplay/Faq/editAction" method="post" enctype="multipart/form-data">
                                <div class="form-body">
                                    <div class="form-group" style="margin-top:10px">
                                        <label class="control-label col-md-2">标题</label>
                                        <div class="col-md-10">
                                            <input type="text" id="" class="form-control" name="title" placeholder="" value="<?php echo ($res["title"]); ?>">
                                            <span class="tip"></span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <textarea id="content" class="form-control" name="content" style="height: 300px"><?php echo ($res["content"]); ?></textarea>
                                            <span class="tip"></span>
                                        </div>
                                    </div>
                                    <div class="form-group" style="margin-top:10px">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" id="weight" class="form-control" name="weight" placeholder="" value="<?php echo ($res["weight"]); ?>">
                                            <span class="tip"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" style="margin-top:10px;">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="hidden" name="sele" id="sele" value="<?php echo ($sele); ?>">
...
<script type="text/javascript">
    ...
    file.addEventListener('change',function(){
        ...
        if(size>2048){
            ...
            if(confirm("图片过大！！！")){
                //跳转网页,并携带参数
                //window.location="/project/index.php/Backenddisplay/Faq/delTypeAction/id/"+id;
            }
        }else{
            // 小于等于2048
