                        ...
                        <div class="portlet-body">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-md-push-2">
                                    <div class="row">
                                        <form action="/project/index.php/Backenddisplay/User/audit" method="get">
                            ...
                            <table class="table table-striped table-bordered table-hover" style="margin-top:10px">
                                ...
                                <?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td>
                                            <?php if($vo["audittype"] == 0): ?><a href="/project/index.php/Backenddisplay/User/auditStatus/id/<?php echo ($vo["id"]); ?>/uid/<?php echo ($vo["uid"]); ?>/type/1/p/<?php echo ($p); ?>/sele/<?php echo ($sele); ?>">未审核</a>
                                                <?php else: ?>
                                                <a href="/project/index.php/Backenddisplay/User/auditStatus/id/<?php echo ($vo["id"]); ?>/uid/<?php echo ($vo["uid"]); ?>/type/0/p/<?php echo ($p); ?>/sele/<?php echo ($sele); ?>">已审核（点击取消审核）</a><?php endif; ?>
                                        </td>
                                        <td><?php echo ($vo["createtime"]); ?></td>
                                        <td>
                                            <?php if(RuleCheck('Backenddisplay/User/auditDel',$_SESSION['uid'])): ?><a href="javascript:del(<?php echo ($vo["id"]); ?>,<?php echo ($p); ?>,'<?php echo ($sele); ?>');">删除 </a><?php endif; ?>
                                        </td>
...
<script>
    ...
    function del(id,p,sele){
        ...
        if(confirm("确定要删除该条数据吗？")){
            //跳转网页,并携带参数
            window.location="/project/index.php/Backenddisplay/User/auditDel/id/"+id+"/p/"+p+"/sele/"+sele;
        }
    }
</script>
</body>
