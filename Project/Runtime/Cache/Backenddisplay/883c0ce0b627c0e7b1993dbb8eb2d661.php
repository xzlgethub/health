                ...
                <div class="col-md-12">
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        ...
                        <div class="portlet-body">
                            <form role="form" class="form-horizontal" action="/project/index.php/Backenddisplay/Rule/editAGaction" method="post">
                                <div class="form-body">
                                    ...
                                    <!--<input type="checkbox" name="rules[]" class="md-check" value="<<?php echo ($vo['id']); ?>>" checked="" />45646-->
                                    <!--<div class="form-group">-->
                                        <!--<div class="col-md-15">-->
                                            <!--<div class="md-checkbox-inline">-->
                                                <!--<?php if(is_array($ares)): foreach($ares as $key=>$vo): ?>-->
                                                <!--<div class="md-checkbox" style="margin-right: 40px; margin-top: 4px;">-->
                                                    <!--<?php if(in_array($vo.id,$res)): ?>-->
                                                        <!--<input type="checkbox" name="rules[]" class="md-check" value="<?php echo ($vo['id']); ?>" checked="true" />-->
                                                        <!--<?php else: ?>-->
                                                        <!--<input type="checkbox" name="rules[]" class="md-check" value="<?php echo ($vo['id']); ?>"/>-->
                                                    <!--<?php endif; ?>-->
                                                    <!--&lt;!&ndash;<?php if(is_array($res)): foreach($res as $key=>$v): ?>&ndash;&gt;-->
                                                        <!--&lt;!&ndash;<?php if($v == $vo['id']): ?><input type="checkbox" name="rules[]" class="md-check" value="<?php echo ($vo['id']); ?>" checked="true" />&ndash;&gt;-->
                                                        <!--&lt;!&ndash;<?php else: ?><input type="checkbox" name="rules[]" class="md-check" value="<?php echo ($vo['id']); ?>"/>&ndash;&gt;-->
                                        ...
                                        <!--</div>-->
                                    <!--</div>-->
                                    <?php if(is_array($ares)): foreach($ares as $key=>$vo): if(in_array($vo['id'],$res['rules'])){?>
                                        <input type="checkbox" name="rules[]" class="md-check" value="<?php echo $vo['id']?>" checked="checked" />
                                        <?php }else{?>
                                        <input type="checkbox" name="rules[]" class="md-check" value="<?php echo $vo['id']?>"  />
                                        <?php }?>
                                        [<?php echo ($vo["title"]); ?>]<?php endforeach; endif; ?>
                                    <br/>
...
<script>
    jQuery(document).ready(function() {
        ...
        Layout.setSidebarMenuActiveLink('set', $('#page6'));
    });
</script>
<script type="text/javascript">
    //启用、关闭
   $('.check').click(function () {
       $('.md-check').prop('checked','checked');
   })
</script>
</body>
<!-- END BODY -->
