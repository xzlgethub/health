            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    <li>
                        ...
                        <a href="/project/index.php/Backenddisplay/Copyright/index">版权预览</a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        ...
                        <div class="portlet-body">
                            <div class="col-md-6" style="margin-bottom:10px;margin-left:-15px">
                                <?php if($res == ''): if(RuleCheck('Backenddisplay/Copyright/add',$_SESSION['uid'])): ?><div class="btn-group">
                                            <a class="btn red-intense" href="/project/index.php/Backenddisplay/Copyright/add"><i class="fa fa-plus"></i> 版权</a>
                                        </div><?php endif; endif; ?>
                            </div>
                            <table class="table table-striped table-bordered table-hover" id="">
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align:middle">
                                        <?php if($res != ''): if(RuleCheck('Backenddisplay/Copyright/edit',$_SESSION['uid'])): ?><a href="/project/index.php/Backenddisplay/Copyright/edit/id/<?php echo ($res["id"]); ?>" >修改</a> |<?php endif; ?>
                                            <?php if(RuleCheck('Backenddisplay/Copyright/delAction',$_SESSION['uid'])): ?><a href="javascript:del(<?php echo ($res["id"]); ?>);">删除 </a><?php endif; endif; ?>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
...
<script>
    function del(id) {
        if (confirm("确定要删除这条消息吗？")) {
            //跳转网页,并携带参数
            window.location = "/project/index.php/Backenddisplay/Copyright/delAction/id/" + id;
        }
    }
</script>
</body>
