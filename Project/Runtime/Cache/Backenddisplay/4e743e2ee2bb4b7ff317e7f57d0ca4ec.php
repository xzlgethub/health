            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        ...
                        <small style="color:#888888">新闻类别预览</small>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>新闻类别预览
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="row">
                                <div class="col-md-3 col-md-push-0">
                                    <?php if(RuleCheck('Backenddisplay/Datadic/addJournalism',$_SESSION['uid'])): ?><div class="btn-group">
                                            <a class="btn red-intense" href="/project/index.php/Backenddisplay/Datadic/addJournalism"><i class="fa fa-plus"></i> 角色</a>
                                        </div><?php endif; ?>
                                </div>
                            </div>
                            <table class="table table-striped table-bordered table-hover" style="margin-top:10px">
                                ...
                                <?php if(is_array($res)): foreach($res as $key=>$res): ?><tr>
                                        ...
                                        <td>
                                            <?php if(RuleCheck('Backenddisplay/Datadic/editJournalism',$_SESSION['uid'])): ?><a href="/project/index.php/Backenddisplay/Datadic/editJournalism/id/<<?php echo ($res["id"]); ?>>">修改</a> |<?php endif; ?>
                                            <?php if(RuleCheck('Backenddisplay/Datadic/delNewstype',$_SESSION['uid'])): ?><a href="javascript:del(<<?php echo ($res["id"]); ?>>);">删除 </a><?php endif; ?>
                                        </td>
...
<script>
    jQuery(document).ready(function () {
        ...
        TableEditable.init();
        Layout.setSidebarMenuActiveLink('set', $('#journalism'));
    });
</script>
<script>
    function del(id){
        if(confirm("确定要删除该条数据吗？")){
            //跳转网页,并携带参数
            window.location="/project/index.php/Backenddisplay/Datadic/delNewstype/id/"+id;
        }
    }
