            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    <li>
                        ...
                        <a href="/project/index.php/Backenddisplay/Feedback/index">意见反馈预览</a>
                    </li>
                    <li>
                        <i class="fa fa-angle-right"></i>
                        <small style="color:#888888">意见反馈预览</small>
                    </li>
                </ul>
            </div>
            <div class="row">
                        ...
                        <div class="portlet-body">
                            <div class="row">
                                <div class="col-md-3 col-md-push-0">
                                    <!--<?php if(RuleCheck('Backenddisplay/Management/add',$_SESSION['uid'])): ?><div class="btn-group">
                                            <a class="btn red-intense" href="/project/index.php/Backenddisplay/Feedback/add"><i class="fa fa-plus"></i> 管理员</a>
                                        </div><?php endif; ?>-->
                                </div>
                                <div class="col-md-8 col-md-push-2">
                                    <div class="row">
                                        <form action="/project/index.php/Backenddisplay/Feedback/index" method="get">
                                            ...
                                            <div class="col-md-8 col-md-push-2" >
                                                ...
                                                <input type="text" name="sele" placeholder="请输入（姓名/意见内容）内容进行搜索" class="form-control" value="<?php echo ($sele); ?>">
                                            </div>
                            ...
                            <table class="table table-striped table-bordered table-hover"  style="margin-top:10px">
                                ...
                                <?php if(is_array($res)): foreach($res as $key=>$res): ?><tr>
                                        ...
                                        <td><?php echo ($res["contact_way"]); ?></td>
                                        <td><?php echo ($res["createtime"]); ?></td>
                                        <td><a href="javascript:del(<?php echo ($res["id"]); ?>,<?php echo ($page); ?>,'<?php echo ($sele); ?>');">删除</a></td>
...
<script>
    jQuery(document).ready(function() {
        ...
        TableAdvanced.init();
        Layout.setSidebarMenuActiveLink('set', $('#Feedback'));
    });
    ...
    function del(id,page,sele){
        ...
        if(confirm("确定要删除该条数据吗？")){
            //跳转网页,并携带参数
            window.location="/project/index.php/Backenddisplay/Feedback/del/id/"+id+"/p/"+page+"/sele/"+sele;
        }
    }
</script>
</body>
