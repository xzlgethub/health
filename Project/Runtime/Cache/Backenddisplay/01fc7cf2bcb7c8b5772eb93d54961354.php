            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        ...
                        <small style="color:#888888">权限组添加</small>
                    </li>
                </ul>
            </div>
                ...
                <div class="col-md-12">
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>权限组添加
                            </div>
                        </div>
                        <div class="portlet-body">
                            <form role="form" class="form-horizontal" action="/project/index.php/Backenddisplay/Rule/addAGaction" method="post">
                                <div class="form-body">
                                    ...
                                    <?php if(is_array($ares)): foreach($ares as $key=>$vo): ?><input type="checkbox" name="rules[]" class="md-check" value="<?php echo $vo['id']?>"  />
                                        [<?php echo ($vo["title"]); ?>]<?php endforeach; endif; ?>
                                    <br/>
                                    <a href="#" class="check" id="qx">全选</a>
                                    <a href="#" class="check" id="qbx">全不选</a>
                                    <a href="#" class="checks">反选</a>
...
<script type="text/javascript">
    $('.check').click(function () {
        if($(this).prop('id')=='qx'){
            ...
            $('.md-check').prop('checked','');
        }
    })
    $('.checks').click(function () {
        var lenght = $('.md-check').length
        for(var i=0;i<lenght;i++){
            // alert($('.md-check'))
            // console.log($('.md-check')[i])
            // console.log($('.md-check')[i])
            if($('.md-check')[i].cheched=='checked'){
                $('.md-check')[i].checked=false;
            }else{
                $('.md-check')[i].checked='checked';
            }
        }
    })
</script>
