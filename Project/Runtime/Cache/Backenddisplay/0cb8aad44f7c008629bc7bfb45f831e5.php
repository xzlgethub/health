            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        ...
                        <small style="color:#888888">管理员修改</small>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>管理员修改
                            </div>
                        </div>
                        <div class="portlet-body">
                            <form role="form" class="form-horizontal form" action="/project/index.php/Backenddisplay/Management/editAction" method="post">
                                <div class="form-body">
                                    <div class="form-group" style="margin-top:10px">
                                        <label class="control-label col-md-2">账号</label>
                                        <div class="col-md-10">
                                            <input type="text" id="username" class="form-control" name="username" value="<?php echo ($res['username']); ?>" readonly>
                                            <span class="tip"></span>
                                    ...
                                    <div class="form-group" style="margin-top:10px">
                                        ...
                                        <div class="col-md-10">
                                            <input type="password" id="password" class="form-control" name="password" value="<?php echo ($res['password']); ?>" >
                                            <span class="tip"></span>
                                        </div>
                                    </div>
                                    <div class="form-group" style="margin-top:10px">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" id="phone" class="form-control" name="phone" value="<?php echo ($res['phone']); ?>" >
                                            <span class="tip"></span>
                                    ...
                                    <div class="form-group" style="margin-top:10px">
                                        ...
                                        <div class="col-md-10">
                                            <select class="form-control" id="type" name="type">
                                                <?php if(is_array($re)): foreach($re as $key=>$re): if($re['status'] == '0'): ?><option value="<<?php echo ($re['id']); ?>>" selected><<?php echo ($re['name']); ?>></option>
                                                        <?php else: ?>
                                    ...
                                    <div class="form-group" style="margin-top:10px;">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="hidden" class="p" name="p" value="<?php echo ($page); ?>">
    ...
    $(function () {
        $(".form-horizontal").validate({
            ...
            submitHandler:function(form){
                ...
                $.ajax({
                    type:"get",
                    url:"/project/index.php/Backenddisplay/Management/vadataajax",
                    data:{username:username,phone:phone,name:name,uid:uid},
