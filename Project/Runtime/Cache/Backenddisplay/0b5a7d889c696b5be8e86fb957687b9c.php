                ...
                <div class="col-md-12">
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        ...
                        <div class="portlet-body">
                            <form role="form" class="form-horizontal form" action="/project/index.php/Backenddisplay/Faq/addAction" method="post" enctype="multipart/form-data">
                                <div class="form-body">
                                    <div class="form-group" style="margin-top:10px">
                                        <label class="control-label col-md-2">标题</label>
                                        <div class="col-md-10">
                                            <input type="text" id="" class="form-control" name="title" placeholder="">
                                            <span class="tip"></span>
                                        </div>
                                    </div>
