            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    <li>
                        ...
                        <a href="/project/index.php/Backenddisplay/Rule/RuleGroup">权限管理</a>
                    </li>
                    <li>
                        <i class="fa fa-angle-right"></i>
                        <small style="color:#888888">权限组预览</small>
                    </li>
                </ul>
            </div>
                ...
                <div class="col-md-12">
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>权限组预览
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="row">
                                <div class="col-md-3 col-md-push-0">
                                    <?php if(RuleCheck('Backenddisplay/Rule/addRuleGroup',$_SESSION['uid'])): ?><div class="btn-group">
                                            <a class="btn red-intense" href="/project/index.php/Backenddisplay/Rule/addRuleGroup"><i class="fa fa-plus"></i> 权限</a>
                                        </div><?php endif; ?>
                                </div>
                                <div class="col-md-5 col-md-push-4">
                                    <div class="row">
                                        <form action="/project/index.php/Backenddisplay/Rule/seeRuleGroup" method="post">
                            ...
                            <table class="table table-striped table-bordered table-hover" style="margin-top:10px">
                                ...
                                <?php if(is_array($res)): foreach($res as $key=>$res): ?><tr>
                                        ...
                                        <td><a data-toggle="modal" data-target="#RuleModal" para-data="<?php echo ($res["rules"]); ?>" class="lookup">点击查看</a></td>
                                        <td>
                                            <?php if($res['status'] == 1 ): ?>开启<?php else: ?>关闭<?php endif; ?>
                                        </td>
                                        <td>
                                            <?php if(RuleCheck('Backenddisplay/Rule/editAGaction',$_SESSION['uid'])): ?><a href="/project/index.php/Backenddisplay/Rule/editRuleGroup/id/<?php echo ($res["id"]); ?>/p/<?php echo ($page); ?>/sele/<?php echo ($sele); ?>">修改</a> |<?php endif; ?>
                                            <?php if(RuleCheck('Backenddisplay/Rule/delRuleGroup',$_SESSION['uid'])): ?><a href="javascript:delRuleGroup(<?php echo ($res["id"]); ?>,<?php echo ($page); ?>,<?php echo ($sele); ?>);">删除 </a><?php endif; ?>
                                        </td>
...
<script>
    function delRuleGroup(id,page,sele){
        if(sele==undefined){
            sele='';
        }
        if(confirm("确定要删除该条数据吗？")){
            //跳转网页,并携带参数
            window.location="/project/index.php/Backenddisplay/Rule/delRuleGroup/id/"+id+"/p/"+page+"/sele/"+sele;
        }
    }
    ...
    $(".lookup").click(function(){
        // 获取 具备权限id
        var rules = $(this).attr('para-data');
        if(rules){
           // 发送ajax请求获取权限名称
            $.ajax({
                url: '/project/index.php/Backenddisplay/Rule/findRule',
                type: 'POST',
                dataType: 'json',
                data: {rules: rules},
