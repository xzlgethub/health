            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    <li>
                        ...
                        <a href="/project/index.php/Backenddisplay/Rule/RuleUser">权限管理</a>
                    </li>
                    <li>
                        ...
                        <div class="portlet-body">
                            <div class="row"></div>
                                ...
                                <?php if(is_array($res)): foreach($res as $key=>$res): ?><tr>
                                        ...
                                        <td>
                                            <?php if(RuleCheck('Backenddisplay/Rule/editRuleUser',$_SESSION['uid'])): ?><a data-toggle="modal" data-target="#auModal" data-id="<?php echo ($res['id']); ?>" data-gid="<?php echo ($res['gid']); ?>" class="sendAjax" href="javascript:;">更改权限组</a><?php endif; ?>
...
<div class="modal fade" id="auModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="/project/index.php/Backenddisplay/Rule/changeAGA" method="post">
            <div class="modal-header">
...
<script>
    function delRule(id){
        if(confirm("确定要删除该条数据吗？")){
            //跳转网页,并携带参数
            window.location="/project/index.php/Backenddisplay/Rule/delRule/id/"+id;
        }
    }
    ...
    $(".sendAjax").click(function(){
        ...
        // 发送ajax请求获取权限名称
        $.ajax({
            url: '/project/index.php/Backenddisplay/Rule/findRuleGroup',
            type: 'POST',
            dataType: 'json',
            data: {gid: gid},
