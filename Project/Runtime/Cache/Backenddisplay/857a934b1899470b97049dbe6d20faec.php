            ...
            <div class="page-bar" style="margin-bottom:20px;margin-top:-10px;">
                <ul class="page-breadcrumb">
                    <li>
                        ...
                        <a href="/project/index.php/Backenddisplay/Advertisement/index">APP图片管理</a>
                    </li>
                    <li>
                        <i class="fa fa-angle-right"></i>
                        <small style="color:#888888">APP图片预览</small>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>APP图片预览
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="row">
                                <div class="col-md-3 col-md-push-0">
                                    <?php if(RuleCheck('Backenddisplay/Advertisement/add',$_SESSION['uid'])): ?><div class="btn-group">
                                            <a class="btn red-intense" href="/project/index.php/Backenddisplay/Advertisement/add"><i class="fa fa-plus"></i>&nbsp;&nbsp;APP引导/启动图</a>
                                        </div><?php endif; ?>
                                </div>
                                <div class="col-md-6 col-md-push-2">
                                    <div class="row">
                                        <form action="/project/index.php/Backenddisplay/Advertisement/seeAdv" method="post">
                                            <div class="col-md-8 col-md-push-5" >
                                                <input type="hidden" name="type" value="1">
                                                <input type="text" name="sele" placeholder="请输入（引导图/启动图）进行搜索" class="form-control" >
                                            </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" style="margin-top:10px">
                                ...
                                <tbody>
                                    <?php if(is_array($res)): foreach($res as $key=>$res): ?><tr>
                                            <td width="10"><img src="/project/Public/authentication/<<?php echo ($res["pic"]); ?>>"  height="100"></td>
                                            <td width="85"><<?php echo ($res["state"]); ?>></td>
                                            <td><<?php echo ($res["time"]); ?>></td>
                                            <td>
                                                <?php if(RuleCheck('Backenddisplay/Advertisement/edit',$_SESSION['uid'])): ?><a href="/project/index.php/Backenddisplay/Advertisement/edit/id/<<?php echo ($res["id"]); ?>>">修改</a> |<?php endif; ?>
                                                <?php if(RuleCheck('Backenddisplay/Advertisement/delAction',$_SESSION['uid'])): ?><a href="javascript:del(<<?php echo ($res["id"]); ?>>);">删除 </a><?php endif; ?>
                                            </td>
...
<script>
    jQuery(document).ready(function () {
        ...
        TableEditable.init();
        Layout.setSidebarMenuActiveLink('set', $('#Advertisement'));
    });
</script>
<script>
    function del(id){
        if(confirm("确定要删除该条数据吗？")){
            //跳转网页,并携带参数
            window.location="/project/index.php/Backenddisplay/Advertisement/delAction/id/"+id;
        }
    }
</script>
</body>
