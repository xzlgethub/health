/*
版权2014年Igor Vaynberg
版本:3.5.1时间戳:2014年7月22日美国东部时间18:58:56星期二
这个软件许可在Apache许可下,2.0版本(“Apache许可”)或GNU
通用公共许可证版本2(“GPL许可”)。你可以选择许可证管理
使用这个软件唯一的条件是你接受所有的条款Apache
许可证或GPL许可证。
你可能获得Apache许可的副本和GPL许可证:

http://www.apache.org/licenses/LICENSE-2.0
http://www.gnu.org/licenses/gpl-2.0.html
除非适用法律要求或书面同意,Apache许可软件分发
或GPL许可分布在一个“目前的”基础上,没有任何形式的保证或条件,
明示或默示。看到Apache许可和特定语言的GPL许可证管理
权限和限制下的Apache许可证和GPL许可证。
